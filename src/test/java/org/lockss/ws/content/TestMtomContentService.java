...
public class TestMtomContentService extends SpringLockssTestCase4 {
  ...
  private MtomContentService proxy;
  private MockRestServiceServer mockRestServer;

  private static final ObjectMapper mapper = new ObjectMapper();

  private static final String TARGET_NAMESPACE = "http://content.ws.lockss.org/";
  private static final String SERVICE_NAME = "MtomContentServiceImplService";
  ...
  public void init() throws MalformedURLException {
    ...
    String wsdlEndpoint = "http://localhost:" + port + "/ws/MtomContentService?wsdl";
    Service srv = Service.create(new URL(wsdlEndpoint), new QName(TARGET_NAMESPACE, SERVICE_NAME));
    proxy = srv.getPort(MtomContentService.class);
